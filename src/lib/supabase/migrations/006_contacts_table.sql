...
-- =================================================================
-- Creates the contacts table required by the Communication page.
-- Contacts hold prospects, tenants, vendors, landlords, and other
-- contact types scoped per company.
-- =================================================================
